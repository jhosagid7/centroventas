        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input name="name" type="text" class="form-control" id="name" value="{{ old('name', $role->name)}}" readonly placeholder="{{__('Name')}}...">
                    </div>

                    <div class="form-group">
                        <label for="slug">{{__('Slug')}}</label>
                        <input name="slug" type="text" class="form-control" id="slug" value="{{ old('slug', $role->slug)}}" readonly placeholder="{{__('slug')}}...">
                    </div>

                    <div class="form-group">
                        <label for="description">{{__('Description')}}</label>
                        <textarea class="form-control" name="description" id="description" readonly placeholder="{{__('Description')}}..." rows="3">{{ old('description', $role->description)}}</textarea>
                      </div>
                    </div>
