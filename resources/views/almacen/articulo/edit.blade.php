...
@section('contenido')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            {{ Form::token() }} --}}
                <form action="{{ route('articulo.update', $articulo->id) }}" enctype="multipart/form-data" method="POST"
                    autocomplete="off" role="buscar">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input id="nombre" type="text" name="nombre" required value="{{ $articulo->nombre }}"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input id="descripcion" type="text" name="descripcion" required
                                    value="{{ $articulo->descripcion }}" class="form-control mayuscula">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <select required name="deposigo_id" id="deposigo_id" class="form-control select2">
                                    <option value="{{ $articulo->area->deposito->id ?? '' }}">
                                        {{ $articulo->area->deposito->nombre ?? '' }}</option>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <select name="area_id" id="area_id" class="form-control select2">
                                    <option value="{{ $articulo->area->id ?? '' }}">{{ $articulo->area->area ?? '' }}
                                    </option>
                                </select>
                    ...
                    @can('haveaccess', 'role.edit')
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input id="stock" type="text" name="stock" required value="{{ $articulo->stock }}"
                                    class="form-control">
                            </div>
                        </div>
                    @endcan
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="unidades" required value="{{ $articulo->unidades }}"
                                class="form-control enteros" placeholder="unidades...">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <select required class="form-control select2" name="vender_al" id="vender_al">
                                ...
                                @if ($articulo->vender_al)
                                    <option value="{{ $articulo->vender_al }}" selected>{{ $articulo->vender_al }}
                                    </option>
                                @endif
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="precio_costo" required
                                    value="{{ floatval($articulo->precio_costo) ?? '' }}" class="form-control decimal">
                            </div>
                        </div>
                    @endcan
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="porEspecial"
                                value="{{ old('porEspecial') }} {{ $articulo->porEspecial }}"
                                class="form-control decimal" placeholder="Porcentaje especial...">
                            <div class="checkbox">
                                <label>
                                    <input name="isDolar" type="checkbox"
                                        @if ($articulo->isDolar == '1') checked
                              ...
                              checked @endif>
                                ...
                                <label>
                                    <input name="isTransPunto" type="checkbox"
                                        @if ($articulo->isTransPunto == '1') checked
                            ...
                            checked @endif>
                                ...
                                <label>
                                    <input name="isEfectivo" type="checkbox"
                                        @if ($articulo->isEfectivo == '1') checked
                        ...
                        <div class="form-group">
                            ...
                            @if ($articulo->imagen != '')
                                <img src="{{ asset('imagenes/articulos/' . $articulo->imagen) }}"
                                    alt="{{ $articulo->nombre }}" height="100px" width="100px">
                            @endif
                        </div>
                    </div>
                                ...
                                success: function(depositos) {
                                    ...
                                    if (depositos.length) {
                                        ...
                                        for (var i = 0; i < depositos.length; i++) {
                                            $('#area_id').append('<option value="' + depositos[i].id +
                                                '">' + depositos[i].area + '</option>');
                                        }
                                    }
                                }
                            });
