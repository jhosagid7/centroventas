                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input id="nombre" type="text" name="nombre" required value="{{ old('nombre') }}"
                                    class="form-control mayuscula" placeholder="Nombre...">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input id="descripcion" type="text" name="descripcion" required
                                    value="{{ old('descripcion') }}" class="form-control mayuscula"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input readonly type="number" name="codigo" value="{{ old('codigo') ?? '' }}"
                                    class="form-control" placeholder="...AUTOGENERADO...">
                            </div>
                        </div>
            ...
            <input type="text" name="stock" required value="0" class="form-control enteros" placeholder="Stock de articulo...">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="unidades" required value="1" class="form-control enteros"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="porEspecial" value="{{ old('porEspecial') }}"
