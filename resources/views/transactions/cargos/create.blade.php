...
<!-- Content Header (Page header) -->
    ...
    <div class="row">
        <div class="col-lg-6">
            <h3>Nuevo Cargo</h3><a class="btn btn-danger" href="{{ url()->previous() }}">{{__('Regresar')}}</a>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="tipo_operacion" readonly required class="form-control" value="{{old('tipo_operacion') ?? 'Cargo'}}" placeholder="Tipo Operacion...">
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="form-group">
