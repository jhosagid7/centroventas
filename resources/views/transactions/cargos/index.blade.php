...
<div class="row">
    <div class="box-footer no-print">
        ...
        <a href="{{URL::action('CargoController@create')}}"><button class='btn btn-success btn-sm'><span class='glyphicon glyphicon-plus'></span> Nuevo cargo</button></a>
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        ...
        @include('transactions.cargos.buscar')
    </div>
</div>
        ...
        <div class="table-responsive">
            ...
            <table id="cate" class="table table-striped table-bordered table-condensed table-hover table-ms">
                ...
                <tbody>
                    ...
                    @if (isset($cargo->id))
                    @include('transactions.cargos.modal')
                 @endif
                    @endforeach
...
@push('sciptsMain')
    ...
    buttons:[
                    ...
                    filename: 'listadod_de_Cargos_excel'
                    },
                    {
                    extend:'pdfHtml5',
                    ...
                    filename: 'listadod_de_Cargos_pdf'
                    },
                    {
                    extend:'print',
                    ...
                    filename: 'listadod_de_Cargos_print'
                    },
                ],
