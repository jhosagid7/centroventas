...
<div class="row">
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <h3>Listado de Facturas por pagar de <b>{{ $creditos[0]->persona->nombre ?? '' }}</b> <a href="{{URL::action('IngresoController@create')}}"><button class='btn btn-success'><span class='glyphicon glyphicon-plus'></span> Nuevo</button></a></h3>
        ...
        <div class="table-responsive">
            ...
            <table id="ingre" class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tbody>
                    ...
                    <?php $deuda_cliente = "App\DetalleCreditoIngreso"::where('ingreso_id',$ing->id)->orderBy('created_at', 'desc')->first();
                    // echo $deuda_cliente['resta'];
                    ?>
                    @if (floatval($deuda_cliente['resta']) > 0)
                    <tr>
                        <td>{{ $ing->id ?? '' }}</td>
                        ...
                        <td>{{ $ing->status ?? '' }}</td>
                        <td>
                        <a href="{{URL::action('DetalleCreditoIngresoController@show', $ing->id)}}"><button class='btn btn-success btn-sm'><span class='fa fa-money'></span></button></a>
