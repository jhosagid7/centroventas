        ...
        $("#credito").on('click', function() {
            ...
            $(document).ready(function() {
                ...
                $("#bt_addP").click(function() {
                    ...
                    $("#total_costo").val(numDecimal(total_p));
                    $("#tipo_pago").val('');
                    $("#tipo_pago").val('Peso');
                    $("#spTotal").html('0.00'); //aqui
                ...
                $("#bt_addTP").click(function() {
                    ...
                    $("#total_costo").val(numDecimal(total_tp));
                    $("#tipo_pago").val('');
                ...
                $("#bt_addM").click(function() {
                    ...
                    $("#total_costo").val(numDecimal(total_m));
                    $("#tipo_pago").val('');
                    $("#tipo_pago").val('Mixto');
                    $("#spTotal").html('0.00'); //aqui
                ...
                $("#bt_addE").click(function() {
                    ...
                    $("#total_costo").val(numDecimal(total_e));
                    $("#tipo_pago").val('');
    ...
    $("#VueltosdispExcedente").val(VueltosvtosPendientes);
        ...
        $("#Vueltosexcdt").show();
            ...
            function resta() {
                ...
                // alert('RestaTotal.innerHTML '+ RestaTotal.innerHTML);
                // alert('valor_restar '+ valor_restar);
                // alert('valor '+ valor);
                // return false;
                // alert('resta '+ resta);
