                ...
                <div class="tab-pane" id="ventas">
                    ...
                    <div class="container-small text-sm">
                        <form id="form1" action="{{ route('venta.store') }}" method="POST" autocomplete="off">
                            @csrf
                            <input id="modo" name="modo" type="text" value="">
                            <input id="precio_costo_unidad" name="precio_costo_unidad" type="text" value="">
                            <input id="precio_costo" name="precio_costo" type="text" value="">
                            <input id="tipo_pago" name="tipo_pago" type="text" value="">
                        <input id="caja_id" name="caja_id" type="text" value="{{$caja->id}}">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                                                        <div class="form group">
                                                            ...
                                                            <input type="text" name="jprecio_venta_d_dolar"
                                                                id="jprecio_venta_d_dolar" class="form-control">
                                                            <input type="text" name="jprecio_compra" id="jprecio_compra"
                                                                class="form-control" placeholder="Precio venta dolar...">
                                                            <input type="text" name="jprecio_venta" id="jprecio_venta"
                                                                class="form-control" placeholder="Precio dolar...">
                                                            <input type="text" name="jprecio_venta_dolar"
                                                    ...
                                                    <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                                                        <div class="form group">
                                                            ...
                                                            <input type="text" name="jprecio_venta_p_dolar"
                                                                id="jprecio_venta_p_dolar" class="form-control">
                                                            <input type="text" name="jprecio_venta_peso"
                                                    ...
                                                    <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                                                        <div class="form group">
                                                            ...
                                                            <input type="text" name="jprecio_venta_tp_dolar"
                                                                id="jprecio_venta_tp_dolar" class="form-control">
                                                            <input type="text" name="jprecio_venta_trans_punto"
                                                    ...
                                                    <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                                                        <div class="form group">
                                                            ...
                                                            <input type="text" name="jprecio_venta_m_dolar"
                                                                id="jprecio_venta_m_dolar" class="form-control">
                                                            <input type="text" name="jprecio_venta_mixto"
                                                    ...
                                                    <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                                                        <div class="form group">
                                                            ...
                                                            <input type="text" name="jprecio_venta_e_dolar"
                                                                id="jprecio_venta_e_dolar" class="form-control">
                                                            <input type="text" name="jprecio_venta_Efectivo"
                                                            ...
                                                            <div class="table-responsive">
                                                                <table id="detalles"
                                                                    ...
                                                                    <tfoot>
                                                                        ...
                                                                        </th><input type="text" name="total_venta"
                                                                            id="total_venta"><input type="text"
                                                                            name="total_ventad" id="total_ventad"><input
                                                                            type="text" name="total_ventap"
                                                                            id="total_ventap"><input type="text"
                                                                            name="total_ventatp" id="total_ventatp"><input
                                                                            type="text" name="total_ventam"
                                                                            id="total_ventam"><input type="text"
...
// alert('por kilo '+precio_compra);
                    ...
                    if (stock >= cantidad) {
                        ...
                        var fila = '<tr class="selected" id="fila' + cont +
                            ...
                            articulo + '</td><td><input type="hidden" name="cantidad[]" value="' + cantidad + '">' + cantidadVer
                             +
                            '</td><td class="success"><input type="text" name="precio_venta[]" value="' + precio_venta +
                            '">' + precio_venta + '</td><td class="success">' + subtotal[cont] +
                            '</td><td class="warning"><input type="text" name="precio_venta_p[]" value="' +
                            dividir(multiplicar(precio_venta_p)) +
                            '">' + formatMoney(verPreciop, 2, ',', '.') + '</td><td class="warning">' + formatMoney(
                                parseFloat(
                                    subtotalp[cont] * tasaP), 2, ',', '.') +
                            '</td><td  class="success"><input type="text" name="precio_venta_tp[]" value="' +
                            ...
                            '</td><td class="warning"><input type="text" name="precio_venta_m[]" value="' +
                                dividir(multiplicar(precio_venta_m)) +
                            '">' + formatMoney(verPreciom, 2, ',', '.') + '</td><td class="warning">' + formatMoney(
                                parseFloat(
                                    subtotalm[cont] * tasaM), 2, ',', '.') +
                            '</td><td class="success"><input name="precio_costo_unidad[]" type="text" value="'+dividir(multiplicar(precio_venta_c))+'"><input type="text" name="precio_venta_e[]" value="' +
                                dividir(multiplicar(precio_venta_e)) +
                            '">' + formatMoney(verPrecioe, 2, ',', '.') + '</td><td class="success">' + formatMoney(
                                parseFloat(
                                    subtotale[cont] * tasaE)) + '</td><td><input type="text" name="descuento[]" value="' +
                            parseFloat(descuento) + '">' + parseFloat(descuento) + '</td><input type="text" name="porEspecial[]" value="'+jporEspecial+'"></tr>';
                        cont++
            ...
            function eliminar(index) {
                ...
                // $("#gestionpago").hide("linear");
                total_costo = numDecimal(total_costo - subtotalPC[index]);
                total       = numDecimal(total - subtotal[index]);
                //  alert('total '+total);
                total_d     = numDecimal(total_d - subtotald[index]);
                //  alert('total d '+total_d);
                total_p     = numDecimal(total_p - subtotalp[index]);
                // alert('total p '+total_p);
                total_tp    = numDecimal(total_tp - subtotaltp[index]);
                // alert('total tp '+total_tp);
                total_m     = numDecimal(total_m - subtotalm[index]);
                // alert('total m '+total_m);
                total_e     = numDecimal(total_e -subtotale[index]);
                ...
                $("#totald").html("<h4>$. " + numDecimal(total_d *tasaD) + "</h4>");
