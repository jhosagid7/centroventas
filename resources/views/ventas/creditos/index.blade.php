...
<div class="row">
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        ...
        <h3>Facturas por cobrar credito clientes</h3>
        @endcan
            ...
            <table id="ven" class="table table-striped table-bordered table-condensed table-hover">
                ...
                @php
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="{{URL::route('creditos.create', ['id' => $credito->persona_id])}}"><button class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-edit'></span></button></a>
