                                        ...
                                        @can('haveaccess', 'cajatotales.show')
                                            <table class="table table-sm table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><h4><strong class="text-blue">Créditos:</strong></h4></th>
                                                    <td></td>
                                                    <th class="text-blue"></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><h4><strong class="text-aqua">Créditos/Vigentes:</h4></strong></th>
                                                ...
                                                @endcan
                                                                                                @can('haveaccess', 'cajatotalventa.show')
                                                <tr>
                                                    <th><h4><strong class="text-danger">Ventas/Crédito:</strong></h4></th>
                                                    <td><h4><strong class="text-danger">{{ $cajas->SumaTotalCantidadVentasCredito ?? '0' }}</h4></strong></td>
                                                    <th class="text-blue"></th>

                                                    <th><h4><strong class="text-danger">Créditos/Vencidos:</strong></h4></th>
                                                    <td><h4><strong class="text-danger">{{ $cajas->SumaTotalCantidadCreditosVencidos ?? '0' }}</h4></strong></td>
                                                    <td></td>
                                                    <th><h4><strong class="text-danger">Total/Ventas/Créd/Nuevos:</strong></h4></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><h4><strong class="text-blue">Créditos/Pagados:</strong></h4></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><h4><strong class="text-aqua">Créditos/Nuevos:</h4></strong></th>
                                                    ...
                                                    @endif</h4></strong></td>
                                                    <td></td>
                                                    <th><h4><strong class="text-aqua">Total/Ventas/Créditos/Pagados:</h4></strong></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><h4><strong class="text-blue">Total/Credítos:</h4></strong></th>
                                                    <td><h4><strong>@if ($cajas->estado == 'Abierta')
