                ...
                <div id="areaImprimir" class="invoice">
                    <section id="imprimir" class="invoice">
                                        ...
                                        @can('haveaccess', 'cajatotales.show')
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><strong>{{ $cajas->SumaTotalCantidadVentas ?? '0' }}</strong></td>
                                                    <th></th>
                                                    ...
                                                    <td><strong>{{ $cajas->SumaTotalCantidadCreditosVigentes - $cajas->SumaTotalCantidadVentasCredito ?? '0' }}</strong></td>
                                                </tr>
                                                @endcan
                                                @can('haveaccess', 'cajautilidad.show')
                                                <tr>
                                                    <th>Ventas/Credíto:</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$cajas->SumaTotalCantidadVentasCreditoPagados ?? '0'}}</td>
                                                </tr>
                                                @endcan
                                                @can('haveaccess', 'cajatotalventa.show')
                                                <tr>
                                                    <th>Total/Ventas:</th>
                                                    <td><b>{{ $cajas->SumaTotalCantidadVentas + $cajas->SumaTotalCantidadVentasCredito + $cajas->SumaTotalCantidadVentasCortesia ?? '0' }}</b></td>
                                                    <th></th>
                                                ...
                                                @can('haveaccess', 'cajatotalventa.show')
                                                <tr>
                                                    <th><h4><strong class="text-blue">Venta Bruto:</strong></h4></th>
                                                ...
                                                @can('haveaccess', 'cajatotalventa.show')
                                                <tr>
                                                    <th><h4><strong class="text-danger">Ventas/Cortesía:</strong></h4></th>
                                                ...
                                                @can('haveaccess', 'cajatotalventa.show')
                                                <tr>
                                                    <th><h4><strong class="text-danger">Ventas/Créd/Nuevos:</strong></h4></th>
                                                ...
                                                <tr>
                                                    <th><h4><strong class="text-aqua">Ventas/Créditos/Pagados:</h4></strong></th>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <th><h4><strong class="text-aqua">Total/Créditos/Pagados:</h4></strong></th>
                                                ...
                                                <tr>
                                                    <th><h4><strong class="text-blue">Ventas/Total/Contable:</h4></strong></th>
                        ...
                        <div class="row">
                            <div class="col-sm-2 col-xs-6">
                                <div class="description-block border-right">
                                    <span class="description-percentage box-title text-bold text-blue"><i class="fa fa-dollar"> </i> {{ number_format(floatval((($cajas->SumaTotalDolarDolar + $cajas->SumaTotalPesoDolar) + ($cajas->SumaTotalPuntoDolar + $cajas->SumaTotalTransferenciaDolar + $cajas->SumaTotalBolivarDolar))),2,',','.') ?? ''}}</span>
                                    <h5 class="description-header">______________</h5>
                                    <h5 class="box-title text-bold">Regis. por Sistema:</h5>
                                    <h5 class="box-title text-bold text-red">- Regis. por Operador:</h5>
                                    <h5 class="description-header">______________</h5>
