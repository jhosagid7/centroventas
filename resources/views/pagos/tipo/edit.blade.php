...
@section('contenido')
    ...
    <div class="row">
        <div class="col-lg-6">
            <h3>Editar el Tipo de pago: {{$articulo->nombre}}</h3>
            ...
            {{ Form::token() }} --}}
    <form action="{{ route('tipo.update', $articulo->id)}}" method="POST" autocomplete="off" role="buscar">
    @csrf
    @method('PUT')
    <div class="row">
    ...
    <div class="box-footer">
        <div class="form-group margin">
            ...
            <a class="btn btn-danger" href="{{route('tipo.index')}}">{{__('Back')}}</a>
        </div>
    </div>
            </form>
        </div>
