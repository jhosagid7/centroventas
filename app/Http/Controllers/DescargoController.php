...
class DescargoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $transaction->tipo_descargo = $request->get('tipo_descargo');
        ...
        return redirect()->action('DescargoController@show', $transaction->id)->with('success', 'El Cargo fué registrado exitosamente');
    }
    ...
    {
        $title = 'Recivo de Descargo';
        $cargos = Transaction::findOrfail($id);

        return view("transactions.descargos.show", compact('title', 'cargos'));
    }
